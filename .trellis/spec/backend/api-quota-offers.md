...
- Standard and fixed-rush publication require a positive merchant-declared maximum concurrency and an explicit prompt-audit declaration. Historical seller TTFT and performance-confirmation timestamps remain optional snapshots and must never block a new publication.
