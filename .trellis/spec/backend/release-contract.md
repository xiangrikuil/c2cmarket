...
- Backend format, vet, tests, race, and `govulncheck` are independent evidence.
  ...
  Version 78 rollback through Versions 78, 77, and 76 to Version 75 before reapplying
  all three migrations, and verifies the Version 65→current legacy-constraint upgrade
