...
- This is a cross-layer contract covering migration `000072_growth_analytics`, the backend `growth` module, auth/session projection, OpenAPI/generated types, `/admin/growth`, and the browser analytics wrapper.
