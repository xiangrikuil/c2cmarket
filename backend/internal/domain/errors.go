...
const (
	...
	CodeAPIQuotaValidityInsufficient      = "API_QUOTA_VALIDITY_INSUFFICIENT"
	...
	CodeCapabilityRequired                = "CAPABILITY_REQUIRED"
	...
	CodeRecentReauthenticationRequired    = "RECENT_REAUTHENTICATION_REQUIRED"
	CodeStudentEmailClaimed               = "STUDENT_EMAIL_CLAIMED"
	CodeStudentEmailNotEligible           = "STUDENT_EMAIL_NOT_ELIGIBLE"
