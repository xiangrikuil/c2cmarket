...
type Repository interface {
	...
	AdminApplyLifecycleWithIdempotency(ctx context.Context, entry idempotency.Entry, input LifecycleActionInput, now time.Time, buildCompletion LifecycleCompletionBuilder) (LifecycleMutationResult, idempotency.Completion, *domain.AppError)
