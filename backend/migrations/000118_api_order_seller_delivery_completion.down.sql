-- Restore the buyer-confirmation delivery-review state.
...
UPDATE api_orders
SET status = 'delivery_submitted',
    completion_source = NULL,
    completed_at = NULL
WHERE status = 'completed'
  AND completion_source = 'seller_delivered';

UPDATE api_orders
SET completion_source = 'buyer_confirmed'
WHERE status = 'completed'
  AND completion_source = 'remedy_confirmed';
