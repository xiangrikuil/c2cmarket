...
import { ArrowRight, BarChart3, CarFront, Clock3, Code2, FileCheck2, Gauge, ListChecks, Megaphone, MessageSquareWarning, ScrollText, ShieldCheck, TriangleAlert } from 'lucide-vue-next'
